...
export async function createBitcoinAdapter(config) {
    ...
    if (config.commitMethod === "op_return" || config.commitMethod === "taproot") {
        return createStubAdapter(config.chainId, "op_return/taproot require optional dependency bitcoinjs-lib");
    }
