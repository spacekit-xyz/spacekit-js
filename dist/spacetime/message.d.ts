...
export declare function createSpacekitMessage<TPayload>(kind: SpacekitMessageKind, payload: TPayload, context: SpacekitMessageContext): SpacekitMessageEnvelope<TPayload>;
